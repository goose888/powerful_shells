...
inputfile = {'US-Twtforcing_6year.nc'};
sitename = 'Twitchell Island';
lat = [38.1055];
lon = [-121.6521];
tstep_sec = '1800';
site_timezone = '-8:00';
metfile = 'US-Twtforcing.nc';
height = 20;
cycle = 5;
...
tair_tot = [tair_temp(17521:length(tair_temp)); tair_temp];
rh_tot = [rh_temp(17521:length(rh_temp)); rh_temp];
wind_tot = [wind_temp(17521:length(wind_temp)); wind_temp];
rainf_tot = [rainf_temp(17521:length(rainf_temp)); rainf_temp];
psurf_tot = [psurf_temp(17521:length(psurf_temp)); psurf_temp];
swdown_tot = [swdown_temp(17521:length(swdown_temp)); swdown_temp];
vpd_tot = [vpd_temp(17521:length(vpd_temp)); vpd_temp];
aco2_tot = [aco2_temp(17521:length(aco2_temp)); aco2_temp];
